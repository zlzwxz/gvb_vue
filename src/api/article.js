...
export const apiCreateArticleReport = (data) => request.post('/articles/reports', data)
export const apiGetArticleReportList = (params) => request.get('/articles/reports', { params })
export const apiHandleArticleReport = (data) => request.put('/articles/reports', data)
