...
export const apiQQLogin = (code) => request.get('/qq_login', { params: { code } })
...
export const apiGetQQLoginPath = (params) => request.get('/qq_login_path', { params })
...
export const apiGetUserPublicProfile = (id) => request.get(`/users/${id}/profile`)
export const apiGetUserSpacePosts = (id, params) => request.get(`/users/${id}/space/posts`, { params })
export const apiGetUserSpaceMessages = (id, params) => request.get(`/users/${id}/space/messages`, { params })
export const apiCreateUserSpacePost = (data) => request.post('/space/posts', data)
export const apiDeleteUserSpacePost = (id) => request.delete(`/space/posts/${id}`)
export const apiCreateUserSpaceMessage = (data) => request.post('/space/messages', data)
export const apiDeleteUserSpaceMessage = (id) => request.delete(`/space/messages/${id}`)
